...
sub new
{
    ...
    $glfs_ffi->attach(glfs_utimens => ['glfs_t', 'string', 'Timespec', 'Timespec'] => 'int');
    $glfs_ffi->attach(glfs_lutimens => ['glfs_t', 'string', 'Timespec', 'Timespec'] => 'int');
    $glfs_ffi->attach(glfs_futimens => ['glfs_fd_t', 'Timespec', 'Timespec'] => 'int');
